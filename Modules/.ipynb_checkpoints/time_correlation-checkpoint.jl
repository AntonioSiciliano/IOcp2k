...
function get_time_correlation_A_B(V, W, N)
    """
    GET THE TIME CORRELATION AMONG A and B
    ======================================
    """
    ...
    # println("WELCOME TO JULIA...")
    # println("Hello from Julia! x = ", typeof(V))
    println(" ==> A B correlations. Computing the windowed average of a trajectory with size ", N)
